###Mostrando json formatado no windows

O retorno dos comando de pesquisa no console do mongo tem uma saída visual desagradável, isso pode ser alterado inserindo o  pretty() no final de cada consulta.

Para não ficar repetitivo é possível configurar o console para que utilize essa claúsula de foma global com o seguinte procedimento:

Na pasta $HOME do windows crie um arquivo com o nome .mongorc.js com a seguinte linha 
...
http://pastebin.com/EFi2xCr8

Faça o download do arquivo ansi166.zip
